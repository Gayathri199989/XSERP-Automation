	...
	public boolean checkICD_0Note(){
		...
		try{
			...
			if(driver.findElement(By.xpath(".//span[text()='"+sGRNNo+"']")).isDisplayed()){
				...
				for(int j=0;j<invoiceTaxDetailsCheck.size();j++){
					invoiceTaxDetailsCheck.get(j).click();
				}
				Thread.sleep(Constant.Min_Sleep);
				js.executeScript("window.scrollBy(0,-2000)");
				invoiceTab.click();
				...
				if(icdGRNList.get(i-1).getText().contains("Checked") && flag1 == true && flag2 == true && flag3 == true && sActNoteValue.contains(sNetValue) &&
		...
		try{
			...
			if(driver.findElement(By.xpath(".//span[text()='"+sGRNNo+"']")).isDisplayed()){
				...
				if(flag1 == true && flag2 == true){
					...
					if((icdGRNList.get(i-1).getText().contains("Checked") || icdGRNList.get(i-1).getText().contains("Party Acknowledgement Pending")) && flag3 == true && flag4 == true &&
							sActNoteValue.contains(sNetValue) && flag6 == true && flag7 == true && 
...
//			amtIGST = Math.round(amtIGST * 100.0) / 100.0;
	...
	public boolean validateGrandTotal_ICD(){
		...
		ArrayList<String> amtTotal_Dr = new ArrayList<String>();
		ArrayList<String> amtTotal_Cr = new ArrayList<String>();
		ArrayList<String> sNetCGST_Dr = new ArrayList<String>();
		ArrayList<String> sNetSGST_Dr = new ArrayList<String>();
		ArrayList<String> sNetIGST_Dr = new ArrayList<String>();
		ArrayList<String> sNetCGST_Cr = new ArrayList<String>();
		ArrayList<String> sNetSGST_Cr = new ArrayList<String>();
		ArrayList<String> sNetIGST_Cr = new ArrayList<String>();
		List<Double> arrayOfTax = new ArrayList<Double>();
		List<Double> arrayOfautoAmtTotal_Cr = new ArrayList<Double>();
		List<Double> arrayOfAmtTotal_Dr = new ArrayList<Double>();
		List<Double> arrayOfAmtTotal_Cr = new ArrayList<Double>();
		List<Double> arrayOfCgst_Dr = new ArrayList<Double>();
		List<Double> arrayOfSGST_Dr = new ArrayList<Double>();
		List<Double> arrayOfIGST_Dr = new ArrayList<Double>();
		List<Double> arrayOfCgst_Cr = new ArrayList<Double>();
		List<Double> arrayOfSGST_Cr = new ArrayList<Double>();
		List<Double> arrayOfIGST_Cr = new ArrayList<Double>();
		...
		try{
			...
			if(driver.findElement(By.xpath(".//span[text()='"+sGRNNo+"']")).isDisplayed()){
				...
				if(flag1 == true && flag2 == true){
					...
					if(icdGRNList.get(i-1).getText().contains("Checked") && flag3 == true && flag4 == true &&
							sActNoteValue.contains(sNetValue) && flag6 == true && flag7 == true && 
							driver.findElement(By.xpath("//td/a[contains(text(),'"+sGRNNo+"')]/following::td[8]/a")).getText().contains("Checked")){
						flag = true;
					}
		...
		try{
			...
			if(noteCreationPage.isDisplayed()){
				...
				if(icdGRNList.get(iGRNActList-1).getText().contains("Pending") && iGRNActList > iGRNList &&
						sTotal.contains(sActNoteValue) && flag1 == true){
					flag = true;
				}
			}
		}catch(Exception e){
...
//			uploadDoc.sendKeys("E:\\ExpensesUpdate.png");
			...
			if(flag1 == true && flag2 == true 
					&& flag3 == true && flag4 == true && flag5 == true && flag6 == true){
				flag = true;
			}
		}catch(Exception e){
...
//				Runtime.getRuntime().exec("E:\\ExpenseBillUpload.exe");//execute AutoIT to upload import file
	...
	public boolean ApproveExpenses(int iRowNo, String sheet) throws Exception{
		boolean flag = false;
		int i;
		List<Double> claimList = new ArrayList<Double>();
		List<Double> approveList = new ArrayList<Double>();
