...
public class PurchasePage {
	...
	// @FindBy(xpath=".//div/a[text()='Job Order']") -Gayathri
	// private WebElement jobPOToggleBtn;
	
	// @FindBy(xpath=".//div/a[text()='Purchase Order']") -Gayathri
	...
	public boolean addPurchase(int iRowNo, String sheet){
		...
		try{
			...
			addPOBtn.click();
			// Constant.waitFor(ExpectedConditions.elementToBeClickable(poToggleBtn), "Failed to load PO add page"); -Gayathri
			if(indentDropDwn.isDisplayed()){
				// poToggleBtn.click(); -Gayathri
...
//			Thread.sleep(Constant.Max_Sleep);
	...
	public boolean validateDataFromIndent(){
		...
		ArrayList<String> sActMaterials = new ArrayList<String>();
		ArrayList<String> sActMaterialCount = new ArrayList<String>();
		ArrayList<String> sPOMaterials = new ArrayList<String>();
		ArrayList<String> sPOMaterialCount = new ArrayList<String>();
		try{
			...
			if(indentDropDwn.isDisplayed()){
				...
				for(int i=0;i<poMaterialList.size();i++){
					sMaterial = poMaterialList.get(i).getText();
	...
	public boolean supplierDrpDwnValidation(){
		boolean flag = false;
		ArrayList<String> sSuplierList = new ArrayList<String>();
		ArrayList<String> sPOMaterials = new ArrayList<String>();
		ArrayList<String> sActSuplierList = new ArrayList<String>();
	...
	public boolean validateIndentOrderBalanceQty(){
		...
		ArrayList<String> sPOMaterialCount = new ArrayList<String>();
		ArrayList<String> sPOOrderedCount = new ArrayList<String>();
		ArrayList<String> sPOBalanceCount = new ArrayList<String>();
		List<Integer> iPOMaterialCount = new ArrayList<Integer>();
		List<Integer> iPOOrderedCount = new ArrayList<Integer>();
		List<Integer> iPOBalanceCount = new ArrayList<Integer>();
	...
	public boolean ValidateMaterialRate(){
		...
		String[] sMaterialList;
		ArrayList<String> sPOMaterials = new ArrayList<String>();
		ArrayList<String> sSupplierAmtList = new ArrayList<String>();
		ArrayList<String> sPOPriceList = new ArrayList<String>();
	...
	public boolean addJobPo_Materials(int iRowNo, String sheet) throws Exception{
		...
		try{
			...
			if(indentDropDwn.isDisplayed()){
				...
				flag4 = TaxAddition(iRowNo,sheet);
				flag3 = validateGrandTotalValue();
				if(flag3 == true && flag4 == true && flag5 == true){
					Thread.sleep(Constant.Min_Sleep);
					addPO.click();
		...
		try{
			...
			if(sMaterial == null){
				...
				for(int i=0;i<sMaterialList.length;i++){
					jse.executeScript("window.scrollBy(0,-5000)", "");
					Thread.sleep(Constant.Min_Sleep);
					materialNameTxt.sendKeys(sMaterialList[i]);
					Thread.sleep(Constant.Min_Sleep);
					driver.findElement(By.xpath("//ul[contains(@id,'ui-id')]/li/a[contains(text(),'"+sMaterialList[i]+"')]")).click();
					Thread.sleep(Constant.Min_Sleep);
