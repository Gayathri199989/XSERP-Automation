	...
	*/
	...
	public void purchaseMandatoryChkBx_Check(){
		...
		try{
			...
			Thread.sleep(Constant.Medium_Sleep);
			if(Constant.isElementPresent(By.xpath(".//*[@id='mandate_po'] [contains(@class,'item-disabled')]")) == true){
	...
	public void purchaseMandatoryChkBx_UnCheck(){
		...
		try{
			mandatePO_configPg.get(0).click();
			Thread.sleep(Constant.Medium_Sleep);
			if(Constant.isElementPresent(By.xpath(".//*[@id='mandate_po'] [contains(@class,'item-disabled')]")) == false){
				js.executeScript("arguments[0].scrollIntoView(true);", save_configModulePopup);
				Thread.sleep(Constant.Min_Sleep);
				mandatePO_configPg.get(1).click();
				Thread.sleep(Constant.Min_Sleep);
	...
	public void reqAckn_Check(){
		...
		try{
			...
			Thread.sleep(Constant.Medium_Sleep);
			if(Constant.isElementPresent(By.xpath(".//*[@id='request_ack'] [contains(@class,'item-disabled')]")) == true){
				js.executeScript("arguments[0].scrollIntoView(true);", save_configModulePopup);
				Thread.sleep(Constant.Min_Sleep);
	...
	public void reqAckn_UnCheck(){
		...
		try{
			reqAckChckBx.get(0).click();
			Thread.sleep(Constant.Medium_Sleep);
			if(Constant.isElementPresent(By.xpath(".//*[@id='request_ack'] [contains(@class,'item-disabled')]")) == false){
				js.executeScript("arguments[0].scrollIntoView(true);", save_configModulePopup);
				Thread.sleep(Constant.Min_Sleep);
				reqAckChckBx.get(1).click();
				Thread.sleep(Constant.Min_Sleep);
	...
	public void blanketPO_Check(){
		...
		try{
			...
			Thread.sleep(Constant.Medium_Sleep);
			if(Constant.isElementPresent(By.xpath(".//*[@id='blanket_po'] [contains(@class,'item-disabled')]")) == true){
				js.executeScript("arguments[0].scrollIntoView(true);", save_configModulePopup);
				Thread.sleep(Constant.Min_Sleep);
	...
	public void blanketPO_UnCheck(){
		...
		try{
			blanketPOChckBx.get(0).click();
			Thread.sleep(Constant.Medium_Sleep);
			if(Constant.isElementPresent(By.xpath(".//*[@id='blanket_po'] [contains(@class,'item-disabled')]")) == false){
				js.executeScript("arguments[0].scrollIntoView(true);", save_configModulePopup);
				Thread.sleep(Constant.Min_Sleep);
				blanketPOChckBx.get(1).click();
				Thread.sleep(Constant.Min_Sleep);
