...
public class StatementsTestCases {
	...
	public void Test070_RunTrialBalanceGenerateStatement() throws Exception{
		...
		extentTest = extent.startTest("Test070_RunTrialBalanceGenerateStatement",
				"Verify Run Trial Balance and Generate Statement ").assignCategory("StatementsTestCases","SanityTests");
		try{
			...
			if(flag == true){
				...
				extentTest.log(LogStatus.FAIL,extentTest.addScreenCapture(Constant.captureScreen_Negative("Test070_RunTrialBalanceGenerateStatement")));
			}
