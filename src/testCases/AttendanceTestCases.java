...
public class AttendanceTestCases {
	...
	public void Test200_ImportAttendace() throws Exception{
		log.startTestCase("Import Attendance");
		extentTest = extent.startTest("Test200_ImportAttendace",
				"validate Import attendance").assignCategory("AttendanceTestCases","SanityTests");
		try{
