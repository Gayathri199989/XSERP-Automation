...
public class NavigateToPages {
	...
	@FindBy(xpath=".//span[text()='Purchase Indent']")
	...
	@FindBy(id="menu_production_planning") //Gayathri add this line
	public WebElement productionModule;
	
	@FindBy(id="li_manufacture_indent") //Gayathri add this line
	private WebElement manufactureindentTab;
	
	@FindBy(id="li_production_plan") //Gayathri add this line
	private WebElement productionplanModule;
	
	public static WebDriver driver; //Gayathri add this line 
	// private WebDriver driver; -Gayathri comment this line
	...
	public void navigateToProduction(){
		try{
			productionModule.click();
			if(manufactureindentTab.isDisplayed()){
				Constant.log.info("Manufacturning indent page is navigated successfully");
			}
		}catch(Exception e){
			System.err.println("Manufacturning indent page is not navigated successfully "+e);
		}
		
	}
	public void navigateToProductionPlan(){
		try{
			productionModule.click();
			if(productionplanModule.isDisplayed()){
				Constant.log.info("Production plan page is navigated successfully");
			}
		}catch(Exception e){
			System.err.println("Production plan page is not navigated successfully "+e);
		}
